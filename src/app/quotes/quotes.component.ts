...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quotes[] = [
    new Quotes (1,'Ludwig','Soft Skills ','The bottleneck is not coding skills, but what we call soft skills.','Ludwig Murimi',new Date(2022,4,9),11,49),
    new Quotes (2,'Valarie','Achieving success','The key to success for all coders is to be able to truly understand the client’s needs and how to meet those needs.','Valarie Nduku',new Date(2022,2,22),4,20),
